...
describe('BlogsPublicController - getPost() (GET: /blogs/:blogId/posts (pagination, sort, search in term))', () => {
  ...
  it('should use default pagination values when none are provided by the client.', async () => {
    ...
    const resGetPosts: Response = await request(server)
      .get(`/${GLOBAL_PREFIX}/blogs/${createdBlog.id}/posts`)
    ...
    if (testLoggingEnabled) {
      TestLoggers.logE2E(
        ...
        'Test №1: BlogsPublicController - getPost() (GET: /blogs/:blogId/posts (pagination, sort, search in term))',
      );
    }
  });
  ...
  it('should use client-provided pagination values to return the correct subset of data(1).', async () => {
    ...
    if (testLoggingEnabled) {
      TestLoggers.logE2E(
        resGetPosts.body,
        resGetPosts.statusCode,
        'Test №2: BlogsPublicController - getPost() (GET: /blogs/:blogId/posts (pagination, sort, search in term))',
      );
    }
  });
  ...
  it('should use client-provided pagination values to return the correct subset of data(2).', async () => {
    ...
    if (testLoggingEnabled) {
      TestLoggers.logE2E(
        resGetPosts.body,
        resGetPosts.statusCode,
        'Test №3: BlogsPublicController - getPost() (GET: /blogs/:blogId/posts (pagination, sort, search in term))',
      );
    }
  });
  ...
  it('should use client-provided pagination values to return the correct subset of data(3).', async () => {
    ...
    if (testLoggingEnabled) {
      TestLoggers.logE2E(
        resGetPosts.body,
        resGetPosts.statusCode,
        'Test №4: BlogsPublicController - getPost() (GET: /blogs/:blogId/posts (pagination, sort, search in term))',
      );
    }
  });
  ...
  it('should return a 400 error if the client has passed invalid pagination values.', async () => {
    ...
    if (testLoggingEnabled) {
      TestLoggers.logE2E(
        resGetPosts.body,
        resGetPosts.statusCode,
        'Test №5: BlogsPublicController - getPost() (GET: /blogs/:blogId/posts (pagination, sort, search in term))',
      );
    }
  });
});
