...
} from '../../src/modules/user-accounts/auth/domain/entities/email-confirmation-code.entity';
...
describe('AuthController - registrationConfirmation() (POST: /auth/registration-confirmation)', () => {
  ...
  it.only('should be confirmed if the user has sent the correct verification code.', async () => {
    ...
    // const user: User | null = await usersRepository.getByEmail(dto.email);
    ...
    // const emailConfirmationRecord_NotConfirmed: EmailConfirmationCode | null =
    ...
    // const emailConfirmationRecord_Confirmed: EmailConfirmationCode | null =
    //   await usersRepository.getEmailConfirmationByUserId(user.id);
    //
  ...
  //     await usersRepository.getByConfirmationCode(
