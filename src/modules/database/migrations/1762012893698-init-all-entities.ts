...
export class InitAllEntities1762012893698 implements MigrationInterface {
  name = 'InitAllEntities1762012893698';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."email_confirmation_codes_confirmation_status_enum" AS ENUM('Confirmed', 'Not confirmed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "reactions_comments" ("reaction_id" integer NOT NULL, "comment_id" integer NOT NULL, "reactionId" integer, "commentId" integer, CONSTRAINT "REL_1f28259dd5b4165f009883259f" UNIQUE ("reactionId"), CONSTRAINT "PK_981dd9e37fac064d8d46c38356f" PRIMARY KEY ("reaction_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "reactions_posts" ("reaction_id" integer NOT NULL, "post_id" integer NOT NULL, CONSTRAINT "PK_9f8682f82832d3a2480f749eae2" PRIMARY KEY ("reaction_id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."reactions_status_enum" AS ENUM('None', 'Like', 'Dislike')`,
    );
    await queryRunner.query(
      `CREATE TABLE "reactions" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "status" "public"."reactions_status_enum" NOT NULL DEFAULT 'None', "user_id" integer NOT NULL, CONSTRAINT "PK_0b213d460d0c473bc2fb6ee27f3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "games" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "status" "public"."games_status_enum" NOT NULL DEFAULT 'PendingSecondPlayer', "start_game_date" TIMESTAMP WITH TIME ZONE, "finish_game_date" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."answers_status_enum" AS ENUM('Correct', 'Incorrect')`,
    );
    await queryRunner.query(
      `CREATE TABLE "answers" ("id" SERIAL NOT NULL, "answer_body" character varying(255) NOT NULL, "status" "public"."answers_status_enum" NOT NULL, "added_at" TIMESTAMP NOT NULL DEFAULT now(), "player_id" integer NOT NULL, "game_question_id" integer NOT NULL, "game_id" integer, CONSTRAINT "UQ_1f151e00f4acf64b4141fdace60" UNIQUE ("player_id", "game_question_id"), CONSTRAINT "PK_9c32cec6c71e06da0254f2226c6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE TYPE "public"."players_role_enum" AS ENUM('Host', 'Player')`);
    await queryRunner.query(
      `CREATE TABLE "players" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "role" "public"."players_role_enum" NOT NULL DEFAULT 'Player', "score" integer NOT NULL DEFAULT '0', "game_id" integer NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "UQ_9778dc0dc50fbefa8f8e76ecd74" UNIQUE ("user_id", "game_id"), CONSTRAINT "PK_de22b8fdeee0c33ab55ae71da3b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reactions_posts" ADD CONSTRAINT "FK_9f8682f82832d3a2480f749eae2" FOREIGN KEY ("reaction_id") REFERENCES "reactions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "reactions_posts" ADD CONSTRAINT "FK_fc81abfbea081f0ecb9e3cfeb7b" FOREIGN KEY ("post_id") REFERENCES "posts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "answers" ADD CONSTRAINT "FK_4a7ca78514f533b22331476b8f7" FOREIGN KEY ("game_id") REFERENCES "games"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "answers" DROP CONSTRAINT "FK_4a7ca78514f533b22331476b8f7"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reactions_posts" DROP CONSTRAINT "FK_fc81abfbea081f0ecb9e3cfeb7b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reactions_posts" DROP CONSTRAINT "FK_9f8682f82832d3a2480f749eae2"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."email_confirmation_codes_confirmation_status_enum"`,
    );
  }
}
