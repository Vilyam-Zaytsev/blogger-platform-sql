...
export class InitAllEntities1763557713656 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "games" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "public_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."games_status_enum" NOT NULL DEFAULT 'PendingSecondPlayer', "start_game_date" TIMESTAMP WITH TIME ZONE, "finish_game_date" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_cb977f621d8b1c2b82f049dd59b" UNIQUE ("public_id"), CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."answers_status_enum" AS ENUM('Correct', 'Incorrect')`,
    );
    await queryRunner.query(
      `CREATE TABLE "answers" ("id" SERIAL NOT NULL, "answer_body" character varying(255) NOT NULL, "status" "public"."answers_status_enum" NOT NULL, "added_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "player_id" integer NOT NULL, "game_question_id" integer NOT NULL, "game_id" integer NOT NULL, CONSTRAINT "UQ_1f151e00f4acf64b4141fdace60" UNIQUE ("player_id", "game_question_id"), CONSTRAINT "PK_9c32cec6c71e06da0254f2226c6" PRIMARY KEY ("id"))`,
    );
