...
export class InitAllEntities1762714129082 implements MigrationInterface {
    name = 'InitAllEntities1762714129082'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "game_questions" ("id" SERIAL NOT NULL, "order" integer NOT NULL, "added_at" TIMESTAMP NOT NULL DEFAULT now(), "game_id" integer NOT NULL, "question_id" integer NOT NULL, CONSTRAINT "UQ_a9a01e420bf7d52384ddfd30875" UNIQUE ("game_id", "order"), CONSTRAINT "UQ_7755e7207f95809211fab8f84d2" UNIQUE ("game_id", "question_id"), CONSTRAINT "PK_8655fa1f9639162ee24c3a5582a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "answers" ("id" SERIAL NOT NULL, "answer_body" character varying(255) NOT NULL, "status" "public"."answers_status_enum" NOT NULL, "added_at" TIMESTAMP NOT NULL DEFAULT now(), "player_id" integer NOT NULL, "game_question_id" integer NOT NULL, "game_id" integer NOT NULL, CONSTRAINT "UQ_1f151e00f4acf64b4141fdace60" UNIQUE ("player_id", "game_question_id"), CONSTRAINT "PK_9c32cec6c71e06da0254f2226c6" PRIMARY KEY ("id"))`);
